...
<pre>
    ...
    POSTROUTING (outfilter)
        ...
        // traffic.
        // TODO: Implement dst-rewritten for rev-snat
        // REVISIT: What to do if the router doesn't have the gateway
        // port?  Note that we allow floating-ips associated via
        // router interfaces.  Do we even care?
        [if default SNAT is enabled on the router]
